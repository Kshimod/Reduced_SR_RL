...
def fullSR1(gamma, alpha, state_n, init_sr, init_weight, stay_prob,             state_list, action_list, RPE_list, weight_list, v1_list, step_list): # weight_list=[[],[],[], ..., []]
    ...
    return weight, state_list, action_list, RPE_list, timestep_list, weight_list, v1_list, step_list

# function for multi episodes
def fullSR2(epi_num, gamma, alpha, state_n, init_sr, init_weight, stay_prob, state_list, action_list, 
            RPE_list, weight_list, v1_list, step_list, epi_num_list):
    epi_length = []
    for k in range(epi_num):
        c_weight, c_state_list, c_action_list, c_RPE_list, timestep_list, c_weight_list, c_v1_list, c_step_list =         fullSR1(gamma, alpha, state_n, init_sr, init_weight, stay_prob, state_list, action_list, RPE_list, weight_list, v1_list, step_list)
    ...
    return c_weight, c_state_list, c_action_list, c_RPE_list, c_weight_list, c_v1_list, epi_num_list, epi_length, c_step_list


# function for multi simulations
def fullSR3(sim_num, epi_num, gamma, alpha, state_n, init_weight, stay_prob, state_list, action_list, 
            RPE_list, weight_list, v1_list, step_list, epi_num_list):
    sim_num_list = []
    ...
    for t in range(sim_num):
        ...
        c_weight, c_state_list, c_action_list, c_RPE_list, c_weight_list, c_v1_list, c_epi_num_list, epi_length, c_step_list =         fullSR2(epi_num, gamma, alpha, state_n, init_sr, init_weight, stay_prob, state_list, action_list, 
                RPE_list, weight_list, v1_list, step_list, epi_num_list)
    ...
    return c_weight, c_state_list, c_action_list, c_RPE_list, c_weight_list, c_v1_list, c_epi_num_list, sim_num_list, c_step_list
...
result = pd.DataFrame({'Simulation': rl[7], 'Episode': rl[6], 'time_step': rl[8], 'State': rl[1], 'Action': rl[2], 
              'RPE': rl[3], 'V1': rl[5], 'W1': rl[4][0], 'W2': rl[4][1], 'W3': rl[4][2], 'W4': rl[4][3], 
